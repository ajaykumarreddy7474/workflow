...
const SideNavbar = () => {
  return (
    <div className="w-[90px] flex flex-col  lg:w-72 bg-blue-700 lg:h-screen">
        <div className="flex flex-col pt-5 ml-3">
<div>

        <Link href='/' className="flex items-center gap-2"> <Image src={T1} alt='pic'></Image> <span className="hidden lg:block font-black text-xl">WORKFLOW</span></Link>
</div>
